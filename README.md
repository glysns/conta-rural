...
1. A ordem das colunas para o arquivo csv será : Nome, Data Nascimento, Sexo, Nome da Mae, Estado Civil, Renda Atual, Telefone, Celular, Email, Logradouro, Numero, Bairro, Complemento, Cidade, Estado
